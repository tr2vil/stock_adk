...
from agents.account_management.agent import AccountManagementAgent
...
class Orchestrator:
    def __init__(self):
        ...
        self.account_agent = AccountManagementAgent()
    ...
    async def process_query(self, user_query: str) -> Dict[str, Any]:
        ...
        - ACCOUNT: 계좌 잔고, 보유 종목, 투자 현황 조회 요청
        ...
        JSON 형식으로 응답하세요:
        {{
            "intent": "NEWS | ACCOUNT | FINANCIAL | PREDICTION | UNKNOWN",
        ...
        if intent_data["intent"] == "ACCOUNT":
            result = await self.account_agent.run("balance")
            return {
                "type": "A2UI_CARD",
